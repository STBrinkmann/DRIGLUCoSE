...
dplyr::tibble(
    ...
    "A" = c(
      "0.41 (0.30-0.54,<br/>p<0.001)", "1.27 (1.19-1.36,<br/>p<0.001)", 
      "0.61 (0.48-0.76,<br/>p<0.001)", "5.54 (4.24-7.33,<br/>p<0.001)", 
      "1.14 (1.12-1.16,<br/>p<0.001)", "0.74 (0.69-0.80,<br/>p<0.001)",
      "0.88 (0.67-1.16,<br/>p=0.385)", "0.76 (0.68-0.85,<br/>p<0.001)",
      "0.74 (0.63-0.88,<br/>p<0.001)", "1.66 (1.32-2.09,<br/>p<0.001)",
      "1.19 (0.92-1.54,<br/>p=0.184)"
    ),
    "B"  = c(
      "0.53 (0.42-0.68,<br/>p<0.001)", "1.20 (1.14-1.25,<br/>p<0.001)",
      "0.86 (0.72-1.03,<br/>p=0.106)", "5.76 (4.82-6.92,<br/>p<0.001)",
    ...
    "C" = c(
      "0.58 (0.45-0.74,<br/>p<0.001)", "1.27 (1.21-1.33,<br/>p<0.001)",
      "0.44 (0.37-0.52,<br/>p<0.001)", "",
      "1.15 (1.13-1.17,<br/>p<0.001)", "0.86 (0.81-0.91,<br/>p<0.001)",
      "0.71 (0.57-0.88,<br/>p=0.002)", "",
      "", "",
      ""
    ),
    "D" = c(
      "0.49 (0.38-0.64,<br/>p<0.001)", "1.19 (1.13-1.26,<br/>p<0.001)",
      "0.80 (0.65-0.99,<br/>p=0.040)", "4.91 (4.00-6.05,<br/>p<0.001)",
      "",                              "0.85 (0.79-0.91,<br/>p<0.001)",
      "0.52 (0.41-0.67,<br/>p<0.001)", "0.87 (0.78-0.96,<br/>p=0.004)",
      "0.87 (0.76-1.00,<br/>p=0.058)", "1.39 (1.14-1.68,<br/>p<0.001)",
      "2.16 (1.74-2.70,<br/>p<0.001)"
    ),
    "E" = c(
      "0.58 (0.45-0.76,<br/>p<0.001)", "1.23 (1.17-1.30,<br/>p<0.001)",
      "0.43 (0.35-0.52,<br/>p<0.001)", "",
      "1.14 (1.12-1.16,<br/>p<0.001)", "0.81 (0.76-0.87,<br/>p<0.001)",
      "0.62 (0.48-0.79,<br/>p<0.001)", "0.93 (0.84-1.03,<br/>p=0.180)",
      "0.93 (0.81-1.08,<br/>p=0.335)", "1.21 (0.99-1.47,<br/>p=0.059)",
...
dplyr::tibble(
    ...
    "OR (WHR-adjusted)"  = c(0.45, 0.67, 0.66, 0.71, 0.37),
    "OR (BMI-adjusted)"  = c(0.48, 0.74, 0.75, 0.65, 0.40),
    "OR (WHR-adjusted) " = c(0.45, 0.72, 0.72, 0.68, 0.40),
    "OR (BMI-adjusted) " = c(0.48, 0.76, 0.77, 0.66, 0.43)
