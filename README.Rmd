...
dplyr::tibble(
    ...
    "A" = c(
      "0.40 (0.30-0.54,<br/>p-value<0.001)", "1.27 (1.19-1.36,<br/>p-value<0.001)", 
      "0.61 (0.48-0.76,<br/>p-value<0.001)", "5.54 (4.24-7.33,<br/>p-value<0.001)", 
      "1.14 (1.12-1.16,<br/>p-value<0.001)", "0.74 (0.69-0.80,<br/>p-value<0.001)",
    ...
    "B)"  = c(
      "0.55 (0.43-0.70,<br/>p-value<0.001)", "1.20 (1.14-1.26,<br/>p-value<0.001)",
    ...
    "C" = c(
      "0.59 (0.46-0.76,<br/>p-value<0.001)", "1.26 (1.20-1.32,<br/>p-value<0.001)",
      "0.46 (0.38-0.54,<br/>p-value<0.001)", "",
      "1.15 (1.13-1.17,<br/>p-value<0.001)", "0.85 (0.80-0.90,<br/>p-value<0.001)",
      "0.72 (0.58-0.90,<br/>p-value=0.003)", "",
      "", "",
      ""
    ),
    "D" = c(
      "0.50 (0.38-0.64,<br/>p-value<0.001)", "1.19 (1.13-1.26,<br/>p-value<0.001)",
      ...
      "0.90 (0.78-1.03,<br/>p-value=0.134)", "1.43 (1.18-1.74,<br/>p-value<0.001)",
    ...
    "E" = c(
      ...
      "0.64 (0.50-0.82,<br/>p-value<0.001)", "0.92 (0.84-1.02,<br/>p-value=0.126)",
      "0.92 (0.80-1.06,<br/>p-value=0.272)", "1.27 (1.04-1.54,<br/>p-value=0.018)",
      "1.81 (1.45-2.26,<br/>p-value<0.001)"
          ...
          format = "latex", col.names = names_spaced, escape = FALSE, align=c("l", "c", "c", "c", "c", "c"),
...
dplyr::tibble(
    ...
    "OR (BMI-adjusted) " = c(0.78, 0.66, 0.44)
          ...
          format = "latex", col.names = names_spaced, escape = FALSE, align=c("l", "c", "c", "c", "c"),
          table.attr = "style='width:90%;'") %>% 
...
readr::read_delim("docs/summary_statistiks.csv", delim = ";") %>% 
  ...
  kableExtra::pack_rows(index = c(" " = 3, "Participant data" = 24, "Census variables" = 28,
