...
dplyr::tibble(
    Parameter = c(
      ...
      "Neighbourhood type: urban", "AHEI Score (E^1)", "Recreation Met Score: d>=525",
      "Current/Former smoker: yes", "Alcohol: <1 drink/day"
    ),
    "A" = c(
      "0.41 (0.30-0.54,<br/>p<0.001)", "1.27 (1.19-1.35,<br/>p<0.001)", 
      "0.60 (0.47-0.75,<br/>p<0.001)", "5.58 (4.19-7.25,<br/>p<0.001)", 
      "1.14 (1.12-1.16,<br/>p<0.001)", "0.75 (0.70-0.80,<br/>p<0.001)",
      "0.86 (0.65-1.12,<br/>p=0.276)", "0.78 (0.69-0.87,<br/>p<0.001)",
      "0.56 (0.44-0.71,<br/>p<0.001)", "1.65 (1.31-2.08,<br/>p<0.001)",
      "1.17 (0.91-1.51,<br/>p=0.225)"
    ),
    "B"  = c(
      "0.55 (0.43-0.70,<br/>p<0.001)", "1.19 (1.14-1.25,<br/>p<0.001)",
      "0.88 (0.74-1.04,<br/>p=0.126)", "5.80 (4.85-6.95,<br/>p<0.001)	",
    ...
    "C" = c(
      "0.59 (0.46-0.76,<br/>p<0.001)", "1.27 (1.21-1.33,<br/>p<0.001)",
      "0.49 (0.42-0.57,<br/>p<0.001)", "",
      "1.15 (1.13-1.17,<br/>p<0.001)", "0.86 (0.81-0.92,<br/>p<0.001)",
      "0.75 (0.61-0.92,<br/>p=0.007)", "",
      "", "",
      ""
    ),
    "D" = c(
      "0.57 (0.44-0.73,<br/>p<0.001)", "1.18 (1.12-1.25,<br/>p<0.001)",
      "0.80 (0.66-0.97,<br/>p=0.026)", "4.47 (3.64-5.49,<br/>p<0.001)",
      "",                              "0.85 (0.79-0.91,<br/>p<0.001)",
      "0.60 (0.48-0.76,<br/>p<0.001)", "0.88 (0.80-0.97,<br/>p=0.011)",
      "0.90 (0.76-1.08,<br/>p=0.271)", "1.50 (1.25-1.79,<br/>p<0.001)",
      "1.60 (1.31-1.97,<br/>p<0.001)"
    ),
    "E" = c(
      "0.67 (0.51-0.88,<br/>p=0.004)", "1.20 (1.14-1.27,<br/>p<0.001)",
      "0.46 (0.39-0.56,<br/>p<0.001)", "",
      "1.16 (1.14-1.18,<br/>p<0.001)", "0.83 (0.78-0.89,<br/>p<0.001)",
      "0.75 (0.59-0.94,<br/>p=0.014)", "0.96 (0.87-1.06,<br/>p=0.403)",
      "0.83 (0.69-1.00,<br/>p=0.046)", "1.34 (1.12-1.61,<br/>p=0.002)",
...
dplyr::tibble(
    Metric = c("Probability Threshold *", "Accuracy", "AROC",  
               "Sensitivity", "Specificity", "Youden index"),
    "OR (WHR-adjusted)"  = c(0.46, 0.67, 0.76, 0.67, 0.71, 0.38),
    "OR (BMI-adjusted)"  = c(0.45, 0.76, 0.78, 0.78, 0.62, 0.40),
    "OR (WHR-adjusted) " = c(0.45, 0.75, 0.77, 0.75, 0.72, 0.47),
    "OR (BMI-adjusted) " = c(0.51, 0.74, 0.80, 0.75, 0.71, 0.46)
...
knitr::include_graphics("docs/forrest_plot_big.svg")
```
\
