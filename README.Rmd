...
erlangen.isorings %>%
  ...
  tmap::tm_lines(col = "time", lwd = 3, style = "cont",
                 ...
                 title.col = "Walking-Distance (minutes)",
...
For SES variable the proportional weights of the census areas within the isochrone are further defined as (4)
